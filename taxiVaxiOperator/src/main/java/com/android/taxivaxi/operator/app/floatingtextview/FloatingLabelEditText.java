...
public class FloatingLabelEditText extends FloatingLabelTextViewBase<EditText> {
	...
	/**
	 * TextWatcher that changes the floating label state when the EditText
	 * content changes between empty and not empty.
	 */
	...
	public void setImeOption() {
		getInputWidget().setImeActionLabel("Sign In", EditorInfo.IME_ACTION_UNSPECIFIED);
	}
