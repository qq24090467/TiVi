...
/**
 * This class represents a <b>Action Button</b>, which is used in <a
 * href="http://www.google.com.ua/design/spec/components/buttons.html">Material
 * Design</a>
 * 
 * @author Vladislav
 * @version 1.0.3
...
public class ActionButton extends View {
	 ...
	 * Creates an instance of the <b>Action Button</b>
	 * <p>
	 * Used when inflating the declared <b>Action Button</b> within XML resource
	 * 
	 * @param context
	 *            context the view is running in
	 * @param attrs
	 ...
	 *            style resource that supplies default values for the view. Can
	 ...
	 *            be 0 to not look for defaults
	 * @param defStyleRes
	 *            resource identifier of a style resource that supplies default
	...
	/**
	 * Initializes the <b>Action Button</b>, which is declared within XML
	 * resource
	 * <p>
	 * Makes calls to different initialization methods for parameters
	 * initialization. For those parameters, which are not declared in the XML
	 * resource, the default value will be used
	 * 
	 * @param context
	 *            context the view is running in
	 * @param attrs
	...
	/**
	 * Initializes the <b>Action Button</b> color for {@link #state} set to
	 * {@link State#NORMAL}
	 * 
	 * @param attrs
	 *            attributes of the XML tag that is inflating the view
	...
	private void initButtonColorPressed(TypedArray attrs) {
		if (attrs.hasValue(R.styleable.ActionButton_button_colorPressed)) {
			buttonColorPressed = attrs.getColor(R.styleable.ActionButton_button_colorPressed, buttonColorPressed);
	...
	/**
	 * Initializes the animation, which is used while showing <b>Action
	 * Button</b>
	 * 
	 * @param attrs
	 *            attributes of the XML tag that is inflating the view
	 ...
	 * <p>
	 * Changing the default size of the image breaks the rules of <a
	 * href="http://www.google.com/design/spec/components/buttons.html">Material
	 * Design</a>
	 * 
	 * @param attrs
	 *            attributes of the XML tag that is inflating the view
	...
	/**
	 * Makes the <b>Action Button</b> to appear and sets its visibility to
	 * {@link #VISIBLE}
	 * <p>
	...
	/**
	 * Makes the <b>Action Button</b> to disappear and sets its visibility to
	 * {@link #INVISIBLE}
	 * <p>
	...
	/**
	 * Completely dismisses the <b>Action Button</b>, sets its visibility to
	 * {@link #GONE} and removes it from the parent view
	 * <p>
	 * After calling this method any calls to {@link #show()} won't result in
	 * showing the <b>Action Button</b> so far as it is removed from the parent
	 * View
	 * <p>
	 * {@link #hideAnimation} is played if set
	 */
	...
	/**
	 * Returns the size of the <b>Action Button</b> in actual pixels (px). Size
	 * of the <b>Action Button</b> is the diameter of the main circle
	 * 
	...
	/**
	 * Sets the type of the <b>Action Button</b> and invalidates the layout of
	 * the view
	 * 
	 * @param type
	 *            type of the <b>Action Button</b>
	 */
	...
	/**
	 * Sets the current state of the <b>Action Button</b> and invalidates the
	 * view
	 * 
	 * @param state
	 *            new state of the <b>Action Button</b>
	 */
	...
	/**
	 * Returns the <b>Action Button</b> color when in {@link State#NORMAL} state
	 * 
	 * @return <b>Action Button</b> color when in {@link State#NORMAL} state
	 */
	...
	/**
	 * Sets the <b>Action Button</b> color when in {@link State#NORMAL} state
	 * and invalidates the view
	 * 
	 * @param buttonColor
	 *            <b>Action Button</b> color when in {@link State#NORMAL} state
	 */
	...
	/**
	 * Sets the <b>Action Button</b> color when in {@link State#PRESSED} state
	 * 
	 * @return <b>Action Button</b> color when in {@link State#PRESSED} state
	 */
	 ...
	 * and invalidates the view
	 * 
	 * @param buttonColorPressed
	 *            <b>Action Button</b> color when in {@link State#PRESSED} state
	 */
	...
	/**
	 * Checks whether <b>Action Button</b> has shadow by determining shadow
	 * radius
	 * <p>
	 * Shadow is disabled if elevation is set API level is {@code 21 Lollipop}
	 * and higher
	 * 
	...
	/**
	 * Returns the <b>Action Button</b> shadow radius in actual pixels (px)
	 * 
	...
	/**
	 * Sets the <b>Action Button</b> shadow radius and invalidates the layout of
	 * the view
	 * <p>
	 * Must be specified in density-independent (dp) pixels, which are then
	 * converted into actual pixels (px). If shadow radius is set to 0, shadow
	 * is removed
	 * 
	 * @param shadowRadius
	 *            shadow radius specified in density-independent (dp) pixels
	 */
	...
	/**
	 * Returns the <b>Action Button</b> shadow X-axis offset in actual pixels
	 * (px)
	 * <p>
	 * If X-axis offset is greater than 0 shadow is shifted right. If X-axis
	 * offset is lesser than 0 shadow is shifted left. 0 X-axis offset means
	 * that shadow is not X-axis shifted at all
	 * 
	 * @return <b>Action Button</b> shadow X-axis offset in actual pixels (px)
	 */
	...
	/**
	 * Sets the <b>Action Button</b> shadow X-axis offset and invalidates the
	 * layout of the view
	 * <p>
	 * If X-axis offset is greater than 0 shadow is shifted right. If X-axis
	 * offset is lesser than 0 shadow is shifted left. 0 X-axis offset means
	 * that shadow is not shifted at all
	 * <p>
	 * Must be specified in density-independent (dp) pixels, which are then
	 * converted into actual pixels (px)
	 * 
	 * @param shadowXOffset
	 *            shadow X-axis offset specified in density-independent (dp)
	 *            pixels
	 */
	...
	/**
	 * Returns the <b>Action Button</b> shadow Y-axis offset in actual pixels
	 * (px)
	 * <p>
	 * If Y-axis offset is greater than 0 shadow is shifted down. If Y-axis
	 * offset is lesser than 0 shadow is shifted up. 0 Y-axis offset means that
	 * shadow is not Y-axis shifted at all
	 * 
	 * @return <b>Action Button</b> shadow Y-axis offset in actual pixels (px)
	 */
	...
	/**
	 * Sets the <b>Action Button</b> shadow Y-axis offset and invalidates the
	 * layout of the view
	 * <p>
	 * If Y-axis offset is greater than 0 shadow is shifted down. If Y-axis
	 * offset is lesser than 0 shadow is shifted up. 0 Y-axis offset means that
	 ...
	 * 
	 * @param shadowYOffset
	 *            shadow Y-axis offset specified in density-independent (dp)
	 *            pixels
	 */
	...
	/**
	 * Sets the <b>Action Button</b> shadow color and invalidates the view
	 * 
	 * @param shadowColor
	...
	/**
	 * Returns the <b>Action Button</b> stroke width in actual pixels (px)
	 * 
	 * @return <b>Action Button</b> stroke width in actual pixels (px)
	 */
	...
	/**
	 * Checks whether <b>Action Button</b> has stroke by checking stroke width
	 * 
	...
	/**
	 * Sets the <b>Action Button</b> stroke width and invalidates the layout of
	 * the view
	 * <p>
	 * Stroke width value must be greater than 0. If stroke width is set to 0
	 * stroke is removed
	 * <p>
	 * Must be specified in density-independent (dp) pixels, which are then
	 * converted into actual pixels (px)
	 * 
	 * @param strokeWidth
	 *            stroke width specified in density-independent (dp) pixels
	 */
	...
	/**
	 * Sets the <b>Action Button</b> stroke color and invalidates the view
	 * 
	 * @param strokeColor
	 *            <b>Action Button</b> stroke color
	 */
	...
	/**
	 * Returns the <b>Action Button</b> image drawable centered inside the view
	 * 
	 * @return <b>Action Button</b> image drawable centered inside the view
	 */
	...
	/**
	 * Checks whether <b>Action Button</b> has an image centered inside the view
	 * 
	 * @return true if <b>Action Button</b> has an image centered inside the
	...
	/**
	 * Places the image drawable centered inside the view and invalidates the
	 * view
	 * <p>
	 * Size of the image while drawing is fit to {@link #imageSize}
	 * 
	 * @param image
	 *            image drawable, which will be placed centered inside the view
	 */
	 ...
	 * 
	 * @param resId
	 *            drawable resource id, which is to be resolved to image
	 *            drawable and used as parameter when calling
	...
	/**
	 * Creates the {@link android.graphics.drawable.BitmapDrawable} from the
	 * given {@link android.graphics.Bitmap} and places it centered inside the
	 * view
	 * 
	 * @param bitmap
	 *            bitmap, from which
	 *            {@link android.graphics.drawable.BitmapDrawable} is created
	 *            and used as parameter when calling
	 *            {@link #setImageDrawable(android.graphics.drawable.Drawable)}
	 */
	...
	/**
	 * Returns the <b>Action Button</b> image size in actual pixels (px). If
	 * <b>Action Button</b> image is not set returns 0
	 * 
	 * @return <b>Action Button</b> image size in actual pixels (px), 0 if image
	 *         is not set
	 */
	 ...
	 * 
	 * @param size
	 *            size of the <b>Action Button</b> image specified in
	 *            density-independent (dp) pixels
	 */
	 ...
	 * 
	 * @param animation
	 *            animation, which is to be used while showing <b>Action
	 *            Button</b>
	 */
	...
	/**
	 * Sets one of the {@link Animations} as animation, which is used while
	 * showing <b>Action Button</b>
	 * 
	 * @param animation
	 *            one of the {@link Animations}, which is to be used while
	 *            showing <b>Action Button</b>
	 */
	 ...
	 * 
	 * @param animation
	 *            animation, which is to be used while hiding <b>Action
	 *            Button</b>
	 */
	...
	/**
	 * Adds additional actions on motion events: 1. Changes the <b>Action
	 * Button</b> {@link #state} to {@link State#PRESSED} on
	 * {@link android.view.MotionEvent#ACTION_DOWN} 2. Changes the <b>Action
	 * Button</b> {@link #state} to {@link State#NORMAL} on
	...
	/**
	 * Adds additional checking whether animation is null before starting to
	 * play it
	 * 
	 * @param animation
	 *            animation to play
	 ...
	 * 
	 * @param canvas
	 *            canvas, on which the drawing is to be performed
	 */
	@SuppressWarnings("all")
	@Override
	 ...
	 * <p>
	 * Uses the stroke corrective, which helps to avoid the elevation
	 * overlapping issue
	 */
	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	...
	public enum Type {
		...
		/**
		 * Returns an {@code id} for specific <b>Action Button</b> type, which
		 * is defined in attributes
		 * 
		 * @return {@code id} for particular <b>Action Button</b> type, which is
		 ...
		 * 
		 * @param id
		 *            an {@code id}, for which <b>Action Button</b> type
		 *            required
	...
	public enum Animations {
		 ...
		 *            context the view is running in
		 * @param animResId
		 *            resource id of the animation, which is to be loaded
