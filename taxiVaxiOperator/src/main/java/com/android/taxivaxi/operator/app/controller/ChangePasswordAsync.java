...
public class ChangePasswordAsync extends AsyncTask<String, String, JSONObject> {
	...
	public ChangePasswordAsync(Context context, Handler handler, String url) {
	...
	protected JSONObject doInBackground(String... params) {
		...
		postParameters.add(new BasicNameValuePair("old_password", params[1]));
		postParameters.add(new BasicNameValuePair("new_password", params[2]));
	...
	protected void onPostExecute(JSONObject result) {
		...
		try {
			if (result != null) {
				...
				AlertDailogCommon.displayErrorDialog("Problem with sever", context);
			}
