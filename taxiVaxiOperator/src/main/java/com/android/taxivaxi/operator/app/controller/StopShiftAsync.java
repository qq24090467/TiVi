...
public class StopShiftAsync extends AsyncTask<String, String, JSONObject> {
	...
	public StopShiftAsync(Context context, Handler handler, String url) {
	...
	protected JSONObject doInBackground(String... params) {
		...
		postParameters.add(new BasicNameValuePair("shift_id", params[1]));
		postParameters.add(new BasicNameValuePair("end_time", params[2]));
