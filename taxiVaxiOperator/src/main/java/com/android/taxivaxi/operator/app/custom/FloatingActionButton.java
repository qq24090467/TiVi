...
/**
 * Deprecated since version <b>1.0.2</b>. Use
 * {@link com.software.shell.fab.ActionButton} class instead. The reason is the
 * rename of base class name from <b>FloatingActionButton</b> to
 * <b>ActionButton</b> and some of the methods, which are present in this class.
 * <p>
 * Will be removed in version 2.0.0. Please use
 * {@link com.software.shell.fab.ActionButton} and methods declared there
 * instead
 * 
 * @author Vladislav
 * @version 1.0.0
...
public class FloatingActionButton extends ActionButton {
	...
	/**
	 * Returns an animation, which is used while showing <b>Floating Action
	 * Button</b>
	 * 
	 * @deprecated since version <b>1.0.2</b>. Please use
	 *             {@link #getShowAnimation()} instead
	 * 
	 * @return animation, which is used while showing <b>Floating Action
	 *         Button</b>
	 */
	@Deprecated
	...
	/**
	 * Sets the animation, which is used while showing <b>Floating Action
	 * Button</b>
	 * 
	 * @deprecated since version <b>1.0.2</b>. Please use
	 *             {@link #setShowAnimation(android.view.animation.Animation)}
	 *             instead
	 * 
	 * @param animation
	 *            animation, which is to be used while showing <b>Floating
	 *            Action Button</b>
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated since version <b>1.0.2</b>. Please use
	 *             {@link #setShowAnimation(com.software.shell.fab.ActionButton.Animations)}
	 *             instead
	 * 
	 * @param animation
	...
	/**
	 * Returns an animation, which is used while hiding <b>Floating Action
	 * Button</b>
	 * 
	 * @deprecated since version <b>1.0.2</b>. Please use
	 *             {@link #getHideAnimation()} instead
	 * 
	 * @return animation, which is used while hiding <b>Floating Action
	 *         Button</b>
	 */
	@Deprecated
	...
	/**
	 * Sets the animation, which is used while hiding <b>Floating Action
	 * Button</b>
	 * 
	 * @deprecated since version <b>1.0.2</b>. Please use
	 *             {@link #setHideAnimation(android.view.animation.Animation)}
	 *             instead
	 * 
	 * @param animation
	 *            animation, which is to be used while hiding <b>Floating Action
	 *            Button</b>
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated since version <b>1.0.2</b>. Please use
	 *             {@link #setHideAnimation(com.software.shell.fab.ActionButton.Animations)}
	 *             )} instead
	 * 
	 * @param animation
	 *            one of the {@link Animations}, which is to be used while
	 ...
	 * Button</b>
	 * 
	 * @deprecated since 1.0.2 and will be removed in version 2.0.0. Use
	 *             <b>show_animation</b> and <b>hide_animation</b> in XML
	 *             instead
	 * 
	 * @param attrs
