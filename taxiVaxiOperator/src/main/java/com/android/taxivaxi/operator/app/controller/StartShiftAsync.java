...
public class StartShiftAsync extends AsyncTask<String, String, JSONObject> {
	...
	public StartShiftAsync(Context context, Handler handler, String url) {
	...
	protected JSONObject doInBackground(String... params) {
		...
		postParameters.add(new BasicNameValuePair("start_time", params[1]));
